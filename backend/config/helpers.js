...
let conn = new Mysqli({
    Host: 'localhost', // IP nom domaine
    post: 3306, // port， par défaut 3306
    user: 'root', // nom user
    passwd: ' monmotdepasse ', // password
   // charset: '', // encodage de la base de données
    db: 'db_shop' // vous pouvez spécifier la base de données ou non
});

let db = conn.emit(false, 'db_shop');
